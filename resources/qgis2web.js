...
map.getView().fit([-10752744.071287, -2119793.430077, -5649349.256170, 131133.862249], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Departaentos del Perú</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (12 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = '@Jorge Perez';
            }
